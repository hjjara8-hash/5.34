...
const ReadModeView: React.FC<ReadModeViewProps> = memo(({ 
  ...
  return (
    <div
      className="fixed inset-0 bg-bg-overlay/60 backdrop-blur-md z-40 flex flex-col p-4 sm:p-8 md:p-12 pt-24 transition-colors duration-300"
      onClick={onClose} 
      role="dialog"
      aria-modal="true"
    >
      ...
      <div
        ...
        onClick={(e) => e.stopPropagation()} 
      >
        <div className={`bg-bubble-ai text-text-primary border border-border-base p-6 sm:p-8 rounded-xl markdown-content shadow-2xl ${getFontSizeClass(readModeFontSizeLevel)} transition duration-200`}>
             <ReactMarkdown 
